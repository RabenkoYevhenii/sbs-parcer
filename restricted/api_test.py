                    ...
                    if participant_id:
                        ...
                        if source_mask.any():
                            ...
                            new_row = {
                                ...
                                "Follow-up": "true",
                                "valid": "Valid",
                                "author": self.accounts[self.current_account][
                                    "name"
                                ]
                                .split("(")[0]
                                .strip(),
