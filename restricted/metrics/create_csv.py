...
def create_empty_csv():
    ...
    columns = [
        ...
        "Даниил",  # Сообщений отправлено Данилом (старые данные)
        "Ярослав",  # Сообщений отправлено Ярославом (messenger2)
        "Антон",  # Сообщений отправлено Антоном (messenger1 - новый)
        "Игорь",  # Сообщений отправлено Игорем (messenger3 - новый)
        ...
        "% Даниил",  # Процент сообщений Данила (старые данные)
        "% Ярослав",  # Процент сообщений Ярослава
        "% Антон",  # Процент сообщений Антона (новый)
        "% Игорь",  # Процент сообщений Игоря (новый)
    ]
